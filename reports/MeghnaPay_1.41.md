...
**Audit Subject**: `MeghnaPay` (`com.modefin.meghnaui`)
...
| :--- | :--- |
| **Application Package** | `com.modefin.meghnaui` |
| **Version** | `1.41` (Code: `53`) |
| **Binary Size** | 36.59 MB |
| **Binary SHA-256** | `88e20e24f6413fcdc8b5fa53ad0b06cde273b1af016c5b219400814582f38dec` |
...
- **Evidence Findings**:
  * Exported component without permission barrier: activity:com.modefin.prelogin.reg.livenessnew.CameraCaptureActivity
  * Exported component without permission barrier: receiver:com.modefin.sms.SMSReceiver
  * Exported component without permission barrier: receiver:com.modefin.sms.SmsConsentReceiver
...
- **Evidence Findings**:
  ...
  * Suspicious high-entropy string constant (6.00 bits/char): ABC...9-_
    ...
    ABC...9-_
    ```
  * Suspicious high-entropy string constant (4.89 bits/char): a-z...　]]
    ```
    a-z...　]]
    ```
