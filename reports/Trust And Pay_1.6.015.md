...
**Audit Subject**: `Trust And Pay` (`com.trustandpay.customer`)
...
| :--- | :--- |
| **Application Package** | `com.trustandpay.customer` |
| **Version** | `1.6.015` (Code: `6015`) |
| **Binary Size** | 28.99 MB |
| **Binary SHA-256** | `36f80afcd1530b74e3ee50f082b8dc5fdd88ec64d5b645b2f09db283050a280f` |
| **Cybersecurity Maturity Score** | **38.0 / 100.0** |
...
| **BB-MFS-10** | Clause 4.1.4.4, 5.1.2.19 | Source Code Protection, Obfuscation & Anti-Tampering | ❌ FAILED | `MEDIUM` | -5 |
...
- **Regulatory Observation**: Violation of Clause 4.1.5.19.c: Found 5 insecure ciphers (e.g. DES, RC4, ECB).
- **Evidence Findings**:
  ...
  * Insecure cipher algorithm detected: Insecure Cipher: RC2
    ...
    Insecure Cipher: RC2
    ```
  * Insecure cipher algorithm detected: Insecure Cipher: Blowfish
    ```
...
- **Regulatory Observation**: Violation of Clause 4.1.2.5 & 4.1.8.4: 1 invasive malware/spyware permissions requested (WRITE_CONTACTS).
- **Evidence Findings**:
...
- **Regulatory Observation**: Identified 3 unprotected exported application components.
- **Evidence Findings**:
  * Exported component without permission barrier: activity:com.trustandpay.customer.modules.submoduls.push_notification.PushActivity
  * Exported component without permission barrier: activity:com.facebook.CustomTabActivity
  * Exported component without permission barrier: receiver:com.trustandpay.customer.modules.login_registration.sim_binding.SimChangeReceivers
...
- **Bangladesh Bank Clause**: `4.1.4.4, 5.1.2.19` (PROTECT & DETECT - Preventing Unauthorized Software)
- **Severity**: `MEDIUM` | **Penalty Applied**: `-5 points`
- **Regulatory Observation**: Violation of Clause 4.1.4.4: Source code not protected. Obfuscation ratio is 8.8%.
- **Evidence Findings**:
  * Low obfuscation index (8.8%). Application business logic is exposed in cleartext class names.
- **Mandated Remediation**: Enable ProGuard / R8 minification and DexGuard anti-tamper protections in build.gradle.
