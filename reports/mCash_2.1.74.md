...
**Audit Subject**: `mCash` (`com.ibbl.mcashcustomer`)
...
| :--- | :--- |
| **Application Package** | `com.ibbl.mcashcustomer` |
| **Version** | `2.1.74` (Code: `174`) |
| **Binary Size** | 116.47 MB |
| **Binary SHA-256** | `05b538c33dd506ed2cd853259d8e382c79145913266f6dd4ea5eccd1df29f0e1` |
...
- **Regulatory Observation**: Violation of Clause 4.1.5.19.c: Found 2 insecure ciphers (e.g. DES, RC4, ECB).
- **Evidence Findings**:
...
- **Evidence Findings**:
  * Suspicious high-entropy string constant (4.68 bits/char): $r8...bys
    ...
    $r8...bys
    ```
  * Suspicious high-entropy string constant (4.59 bits/char): acc...$cp
    ```
    acc...$cp
    ```
  * Suspicious high-entropy string constant (4.57 bits/char): get...yh8
    ```
    get...yh8
    ```
